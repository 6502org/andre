...
(function ($) {
    ...
    $.fn.socialSharePrivacy = function (settings) {
        var defaults = {
            ...
            'txt_help'          : 'When activating the fields by clicking on them, information is being sent to Facebook Twitter or Google in the USA an can be stored there. More detail available by clicking the <em>i</em>.',
